package com.avinfo.avmusic.Handlers;
...
import com.avinfo.avmusic.Activities.ActivityMain;
...
public class NotificationHandler extends BroadcastReceiver {
    public static final String ACTION_PAUSE = "com.avinfo.avmusic.pause";
    public static final String ACTION_PLAY = "com.avinfo.avmusic.play";
    public static final String ACTION_PREV = "com.avinfo.avmusic.prev";
    public static final String ACTION_NEXT = "com.avinfo.avmusic.next";
    public static final String ACTION_STOP = "com.avinfo.avmusic.stop";
    private static final String CHANNEL_ID = "com.avinfo.avmusic.AV_MUSIC_CHANNEL_ID";
    ...
    public NotificationHandler(ServicePlayMusic service) throws RemoteException {
        ...
        mNotificationColor = UtilsExtra.getThemeColor(mService, R.attr.colorPrimary,
                Color.DKGRAY);
    ...
    private PendingIntent createContentIntent() {
        Intent openUI = new Intent(mService, ActivityMain.class);
    ...
    private void createNotificationChannel() {
        if (mNotificationManager.getNotificationChannel(CHANNEL_ID) == null) {
            NotificationChannel notificationChannel =
                    new NotificationChannel(CHANNEL_ID, "avmusic",
